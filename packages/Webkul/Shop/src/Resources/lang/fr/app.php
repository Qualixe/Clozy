...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'Voir tous les résultats pour',
    ...
    'track_order' => [
        'page_title' => 'Suivez votre commande',
        'heading' => 'Suivez votre commande',
        'intro' => 'Saisissez votre numéro de commande et l\'adresse e-mail utilisée lors du paiement pour voir son statut.',
        'order_number' => 'Numéro de commande',
        'email' => 'Adresse e-mail',
        'submit' => 'Suivre la commande',
        'not_found' => 'Nous n\'avons trouvé aucune commande correspondant à ce numéro de commande et à cet e-mail. Veuillez vérifier et réessayer.',
        'guest_dropdown_link' => 'Suivre une commande',
    ],

    'guest_email_verification' => [
        'page_title' => 'Vérifiez votre e-mail',
        'heading' => 'Vérifiez votre e-mail pour continuer',
        'intro' => 'Pour nous aider à prévenir les commandes frauduleuses, veuillez vérifier votre adresse e-mail avant de passer au paiement.',
        'email' => 'Adresse e-mail',
        'send_code' => 'Envoyer le code de vérification',
        'code_sent' => 'Nous avons envoyé un code à 6 chiffres à :email. Saisissez-le ci-dessous pour continuer.',
        'code' => 'Code de vérification',
        'verify' => 'Vérifier et continuer',
        'resend' => 'Renvoyer le code',
        'invalid_code' => 'Ce code est invalide ou a expiré. Veuillez réessayer ou renvoyer le code.',
        'email_mismatch' => 'L\'e-mail de votre commande ne correspond pas à celui que vous avez vérifié. Veuillez vérifier à nouveau votre e-mail pour continuer.',
        'send_failed' => 'Nous n\'avons pas pu envoyer de code de vérification à cette adresse. Veuillez vérifier l\'adresse et réessayer.',

        'mail' => [
            'subject' => 'Votre code de vérification de paiement',
            'title' => 'Vérifiez votre e-mail',
            'intro' => 'Utilisez le code ci-dessous pour vérifier votre e-mail et poursuivre votre commande. Ce code expire dans :minutes minutes.',
