...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'مشاهده همه نتایج برای',
    ...
    'track_order' => [
        'page_title' => 'پیگیری سفارش شما',
        'heading' => 'پیگیری سفارش شما',
        'intro' => 'برای مشاهده وضعیت سفارش، شماره سفارش و آدرس ایمیلی که هنگام پرداخت استفاده کرده‌اید را وارد کنید.',
        'order_number' => 'شماره سفارش',
        'email' => 'آدرس ایمیل',
        'submit' => 'پیگیری سفارش',
        'not_found' => 'سفارشی مطابق با این شماره سفارش و ایمیل پیدا نشد. لطفاً بررسی کرده و دوباره تلاش کنید.',
        'guest_dropdown_link' => 'پیگیری یک سفارش',
    ],

    'guest_email_verification' => [
        'page_title' => 'ایمیل خود را تأیید کنید',
        'heading' => 'برای ادامه، ایمیل خود را تأیید کنید',
        'intro' => 'برای کمک به جلوگیری از سفارش‌های جعلی، لطفاً قبل از ادامه پرداخت، آدرس ایمیل خود را تأیید کنید.',
        'email' => 'آدرس ایمیل',
        'send_code' => 'ارسال کد تأیید',
        'code_sent' => 'ما یک کد ۶ رقمی به :email ارسال کردیم. برای ادامه آن را در زیر وارد کنید.',
        'code' => 'کد تأیید',
        'verify' => 'تأیید و ادامه',
        'resend' => 'ارسال مجدد کد',
        'invalid_code' => 'آن کد نامعتبر است یا منقضی شده است. لطفاً دوباره امتحان کنید یا کد را دوباره ارسال کنید.',
        'email_mismatch' => 'ایمیل سفارش شما با ایمیلی که تأیید کرده‌اید مطابقت ندارد. لطفاً برای ادامه، ایمیل خود را دوباره تأیید کنید.',
        'send_failed' => 'ما نتوانستیم کد تأیید را به آن آدرس ارسال کنیم. لطفاً آدرس را بررسی کرده و دوباره تلاش کنید.',

        'mail' => [
            'subject' => 'کد تأیید پرداخت شما',
            'title' => 'ایمیل خود را تأیید کنید',
            'intro' => 'از کد زیر برای تأیید ایمیل خود و ادامه سفارش استفاده کنید. این کد ظرف :minutes دقیقه منقضی می‌شود.',
            'ignore' => 'اگر این درخواست را نداده‌اید، می‌توانید این ایمیل را نادیده بگیرید.',
        ],
    ],
