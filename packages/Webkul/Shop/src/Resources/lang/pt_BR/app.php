...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'Ver todos os resultados para',
    ...
    'track_order' => [
        'page_title' => 'Rastreie seu pedido',
        'heading' => 'Rastreie seu pedido',
        'intro' => 'Digite o número do pedido e o e-mail usado na finalização da compra para ver o status.',
        'order_number' => 'Número do pedido',
        'email' => 'Endereço de e-mail',
        'submit' => 'Rastrear pedido',
        'not_found' => 'Não encontramos nenhum pedido correspondente a esse número de pedido e e-mail. Verifique os dados e tente novamente.',
        'guest_dropdown_link' => 'Rastrear um pedido',
    ],

    'guest_email_verification' => [
        'page_title' => 'Verifique seu e-mail',
        'heading' => 'Verifique seu e-mail para continuar',
        'intro' => 'Para ajudar a evitar pedidos fraudulentos, verifique seu endereço de e-mail antes de continuar para o checkout.',
        'email' => 'Endereço de e-mail',
        'send_code' => 'Enviar código de verificação',
        'code_sent' => 'Enviamos um código de 6 dígitos para :email. Digite-o abaixo para continuar.',
        'code' => 'Código de verificação',
        'verify' => 'Verificar e continuar',
        'resend' => 'Reenviar código',
        'invalid_code' => 'Esse código é inválido ou expirou. Tente novamente ou reenvie o código.',
        'email_mismatch' => 'O e-mail do seu pedido não corresponde ao que você verificou. Verifique seu e-mail novamente para continuar.',
        'send_failed' => 'Não conseguimos enviar um código de verificação para esse endereço. Verifique o endereço e tente novamente.',

        'mail' => [
            'subject' => 'Seu código de verificação de checkout',
            'title' => 'Verifique seu e-mail',
            'intro' => 'Use o código abaixo para verificar seu e-mail e continuar seu pedido. Este código expira em :minutes minutos.',
