...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'সব ফলাফল দেখুন',
    ...
    'track_order' => [
        'page_title' => 'আপনার অর্ডার ট্র্যাক করুন',
        'heading' => 'আপনার অর্ডার ট্র্যাক করুন',
        'intro' => 'অর্ডারের অবস্থা দেখতে আপনার অর্ডার নম্বর এবং চেকআউটে ব্যবহৃত ইমেইল ঠিকানা লিখুন।',
        'order_number' => 'অর্ডার নম্বর',
        'email' => 'ইমেইল ঠিকানা',
        'submit' => 'অর্ডার ট্র্যাক করুন',
        'not_found' => 'আমরা সেই অর্ডার নম্বর এবং ইমেইলের সাথে মিলে এমন কোনো অর্ডার খুঁজে পাইনি। অনুগ্রহ করে পরীক্ষা করে আবার চেষ্টা করুন।',
        'guest_dropdown_link' => 'অর্ডার ট্র্যাক করুন',
    ],

    'guest_email_verification' => [
        'page_title' => 'আপনার ইমেইল যাচাই করুন',
        'heading' => 'চালিয়ে যেতে আপনার ইমেইল যাচাই করুন',
        'intro' => 'জাল অর্ডার প্রতিরোধ করতে সাহায্য করার জন্য, চেকআউটে যাওয়ার আগে অনুগ্রহ করে আপনার ইমেইল ঠিকানা যাচাই করুন।',
        'email' => 'ইমেইল ঠিকানা',
        'send_code' => 'যাচাইকরণ কোড পাঠান',
        'code_sent' => 'আমরা :email এ একটি ৬-সংখ্যার কোড পাঠিয়েছি। চালিয়ে যেতে নিচে এটি লিখুন।',
        'code' => 'যাচাইকরণ কোড',
        'verify' => 'যাচাই করুন এবং চালিয়ে যান',
        'resend' => 'কোড পুনরায় পাঠান',
        'invalid_code' => 'সেই কোডটি অবৈধ বা মেয়াদ শেষ হয়ে গেছে। অনুগ্রহ করে আবার চেষ্টা করুন বা কোড পুনরায় পাঠান।',
        'email_mismatch' => 'আপনার অর্ডারের ইমেইল আপনি যাচাই করা ইমেইলের সাথে মেলে না। চালিয়ে যেতে অনুগ্রহ করে আপনার ইমেইল আবার যাচাই করুন।',
        'send_failed' => 'আমরা সেই ঠিকানায় একটি যাচাইকরণ কোড পাঠাতে পারিনি। অনুগ্রহ করে ঠিকানাটি পরীক্ষা করে আবার চেষ্টা করুন।',

        'mail' => [
            'subject' => 'আপনার চেকআউট যাচাইকরণ কোড',
            'title' => 'আপনার ইমেইল যাচাই করুন',
            'intro' => 'আপনার ইমেইল যাচাই করতে এবং আপনার অর্ডার চালিয়ে যেতে নিচের কোডটি ব্যবহার করুন। এই কোডটি :minutes মিনিটে মেয়াদ শেষ হবে।',
            'ignore' => 'আপনি যদি এটি অনুরোধ না করেন, তাহলে আপনি নিরাপদে এই ইমেইলটি উপেক্ষা করতে পারেন।',
        ],
    ],
