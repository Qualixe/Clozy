...
return [
    ...
    'search' => [
        ...
        'no-results' => 'Товарів не знайдено.',
        'view-all-results' => 'Переглянути всі результати за запитом',
    ...
    'track_order' => [
        'page_title' => 'Відстежити замовлення',
        'heading' => 'Відстежити замовлення',
        'intro' => 'Введіть номер замовлення та адресу електронної пошти, використану під час оформлення, щоб побачити його статус.',
        'order_number' => 'Номер замовлення',
        'email' => 'Адреса електронної пошти',
        'submit' => 'Відстежити замовлення',
        'not_found' => 'Ми не змогли знайти замовлення, що відповідає цьому номеру замовлення та електронній пошті. Будь ласка, перевірте дані та спробуйте ще раз.',
        'guest_dropdown_link' => 'Відстежити замовлення',
    ],

    'guest_email_verification' => [
        'page_title' => 'Підтвердьте свою електронну пошту',
        'heading' => 'Підтвердьте свою електронну пошту, щоб продовжити',
        'intro' => 'Щоб допомогти нам запобігти шахрайським замовленням, будь ласка, підтвердьте свою адресу електронної пошти перед оформленням замовлення.',
        'email' => 'Адреса електронної пошти',
        'send_code' => 'Надіслати код підтвердження',
        'code_sent' => 'Ми надіслали 6-значний код на :email. Введіть його нижче, щоб продовжити.',
        'code' => 'Код підтвердження',
        'verify' => 'Підтвердити і продовжити',
        'resend' => 'Надіслати код повторно',
        'invalid_code' => 'Цей код недійсний або термін його дії минув. Спробуйте ще раз або надішліть код повторно.',
        'email_mismatch' => 'Електронна пошта у вашому замовленні не збігається з підтвердженою. Будь ласка, підтвердьте свою електронну пошту знову, щоб продовжити.',
        'send_failed' => 'Ми не змогли надіслати код підтвердження на цю адресу. Будь ласка, перевірте адресу та спробуйте ще раз.',

        'mail' => [
            'subject' => 'Ваш код підтвердження оформлення замовлення',
            'title' => 'Підтвердьте свою електронну пошту',
            'intro' => 'Використайте код нижче, щоб підтвердити свою електронну пошту та продовжити оформлення замовлення. Термін дії цього коду закінчується через :minutes хвилин.',
            'ignore' => 'Якщо ви не надсилали цей запит, можете спокійно проігнорувати цей лист.',
        ],
    ],
