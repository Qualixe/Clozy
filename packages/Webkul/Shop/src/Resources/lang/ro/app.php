...
return [
    ...
    'track_order' => [
        'page_title' => 'Urmărește comanda ta',
        'heading' => 'Urmărește comanda ta',
        'intro' => 'Introdu numărul comenzii și adresa de e-mail folosită la finalizarea comenzii pentru a vedea starea acesteia.',
        'order_number' => 'Numărul comenzii',
        'email' => 'Adresă de e-mail',
        'submit' => 'Urmărește comanda',
        'not_found' => 'Nu am găsit nicio comandă care să corespundă acestui număr de comandă și e-mail. Te rugăm să verifici și să încerci din nou.',
        'guest_dropdown_link' => 'Urmărește o comandă',
    ],

    'guest_email_verification' => [
        'page_title' => 'Verifică-ți e-mailul',
        'heading' => 'Verifică-ți e-mailul pentru a continua',
        'intro' => 'Pentru a ne ajuta să prevenim comenzile frauduloase, te rugăm să îți verifici adresa de e-mail înainte de a continua la finalizarea comenzii.',
        'email' => 'Adresă de e-mail',
        'send_code' => 'Trimite codul de verificare',
        'code_sent' => 'Am trimis un cod din 6 cifre la :email. Introdu-l mai jos pentru a continua.',
        'code' => 'Cod de verificare',
        'verify' => 'Verifică și continuă',
        'resend' => 'Retrimite codul',
        'invalid_code' => 'Acel cod este invalid sau a expirat. Te rugăm să încerci din nou sau să retrimiți codul.',
        'email_mismatch' => 'E-mailul comenzii tale nu se potrivește cu cel verificat. Te rugăm să îți verifici din nou e-mailul pentru a continua.',
        'send_failed' => 'Nu am putut trimite un cod de verificare la acea adresă. Te rugăm să verifici adresa și să încerci din nou.',

        'mail' => [
            'subject' => 'Codul tău de verificare pentru finalizarea comenzii',
            'title' => 'Verifică-ți e-mailul',
            'intro' => 'Folosește codul de mai jos pentru a-ți verifica e-mailul și a continua comanda. Acest cod expiră în :minutes minute.',
            'ignore' => 'Dacă nu ai solicitat acest lucru, poți ignora acest e-mail în siguranță.',
        ],
    ],
