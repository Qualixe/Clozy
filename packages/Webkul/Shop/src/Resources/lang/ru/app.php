...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'Посмотреть все результаты по запросу',
    ...
    'track_order' => [
        'page_title' => 'Отследить заказ',
        'heading' => 'Отследить заказ',
        'intro' => 'Введите номер заказа и адрес электронной почты, использованный при оформлении заказа, чтобы увидеть его статус.',
        'order_number' => 'Номер заказа',
        'email' => 'Адрес электронной почты',
        'submit' => 'Отследить заказ',
        'not_found' => 'Мы не смогли найти заказ, соответствующий этому номеру заказа и адресу электронной почты. Пожалуйста, проверьте данные и попробуйте снова.',
        'guest_dropdown_link' => 'Отследить заказ',
    ],

    'guest_email_verification' => [
        'page_title' => 'Подтвердите ваш e-mail',
        'heading' => 'Подтвердите ваш e-mail, чтобы продолжить',
        'intro' => 'Чтобы помочь нам предотвратить мошеннические заказы, пожалуйста, подтвердите свой адрес электронной почты перед оформлением заказа.',
        'email' => 'Адрес электронной почты',
        'send_code' => 'Отправить код подтверждения',
        'code_sent' => 'Мы отправили 6-значный код на :email. Введите его ниже, чтобы продолжить.',
        'code' => 'Код подтверждения',
        'verify' => 'Подтвердить и продолжить',
        'resend' => 'Отправить код повторно',
        'invalid_code' => 'Этот код недействителен или истёк. Пожалуйста, попробуйте снова или отправьте код повторно.',
        'email_mismatch' => 'Адрес электронной почты в вашем заказе не совпадает с подтверждённым. Пожалуйста, подтвердите свой e-mail снова, чтобы продолжить.',
        'send_failed' => 'Мы не смогли отправить код подтверждения на этот адрес. Пожалуйста, проверьте адрес и попробуйте снова.',

        'mail' => [
            'subject' => 'Ваш код подтверждения для оформления заказа',
            'title' => 'Подтвердите ваш e-mail',
            'intro' => 'Используйте код ниже, чтобы подтвердить свой e-mail и продолжить оформление заказа. Этот код истекает через :minutes минут.',
            'ignore' => 'Если вы не запрашивали это, вы можете спокойно проигнорировать это письмо.',
        ],
    ],
