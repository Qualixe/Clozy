...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'View all results for',
    ...
    'track_order' => [
        ...
        'intro' => 'Enter your order number and the email address used at checkout to see its status.',
        'order_number' => 'Order number',
        'email' => 'Email address',
        'submit' => 'Track Order',
        'not_found' => 'We could not find an order matching that order number and email. Please check and try again.',
        'guest_dropdown_link' => 'Track an Order',
    ],

    'guest_email_verification' => [
        'page_title' => 'Verify Your Email',
        'heading' => 'Verify Your Email to Continue',
        'intro' => 'To help us prevent fraudulent orders, please verify your email address before proceeding to checkout.',
        'email' => 'Email address',
        'send_code' => 'Send Verification Code',
        'code_sent' => 'We sent a 6-digit code to :email. Enter it below to continue.',
        'code' => 'Verification code',
        'verify' => 'Verify & Continue',
        'resend' => 'Resend code',
        'invalid_code' => 'That code is invalid or has expired. Please try again or resend the code.',
        'email_mismatch' => 'The email on your order does not match the one you verified. Please verify your email again to continue.',
        'send_failed' => 'We could not send a verification code to that address. Please check the address and try again.',

        'mail' => [
            'subject' => 'Your checkout verification code',
            'title' => 'Verify Your Email',
            'intro' => 'Use the code below to verify your email and continue with your order. This code expires in :minutes minutes.',
