...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'Vedi tutti i risultati per',
    ...
    'track_order' => [
        'page_title' => 'Traccia il tuo ordine',
        'heading' => 'Traccia il tuo ordine',
        'intro' => 'Inserisci il numero d\'ordine e l\'indirizzo email utilizzato al checkout per vederne lo stato.',
        'order_number' => 'Numero d\'ordine',
        'email' => 'Indirizzo email',
        'submit' => 'Traccia ordine',
        'not_found' => 'Non abbiamo trovato nessun ordine corrispondente a questo numero d\'ordine ed email. Controlla e riprova.',
        'guest_dropdown_link' => 'Traccia un ordine',
    ],

    'guest_email_verification' => [
        'page_title' => 'Verifica la tua email',
        'heading' => 'Verifica la tua email per continuare',
        'intro' => 'Per aiutarci a prevenire ordini fraudolenti, verifica il tuo indirizzo email prima di procedere al checkout.',
        'email' => 'Indirizzo email',
        'send_code' => 'Invia codice di verifica',
        'code_sent' => 'Abbiamo inviato un codice a 6 cifre a :email. Inseriscilo qui sotto per continuare.',
        'code' => 'Codice di verifica',
        'verify' => 'Verifica e continua',
        'resend' => 'Reinvia codice',
        'invalid_code' => 'Quel codice non è valido o è scaduto. Riprova o reinvia il codice.',
        'email_mismatch' => 'L\'email del tuo ordine non corrisponde a quella verificata. Verifica di nuovo la tua email per continuare.',
        'send_failed' => 'Non siamo riusciti a inviare un codice di verifica a quell\'indirizzo. Controlla l\'indirizzo e riprova.',

        'mail' => [
            'subject' => 'Il tuo codice di verifica per il checkout',
            'title' => 'Verifica la tua email',
            'intro' => 'Usa il codice qui sotto per verificare la tua email e continuare con il tuo ordine. Questo codice scade tra :minutes minuti.',
