...
return [
    ...
    'track_order' => [
        'page_title' => 'עקוב אחר ההזמנה שלך',
        'heading' => 'עקוב אחר ההזמנה שלך',
        'intro' => 'הזן את מספר ההזמנה וכתובת האימייל ששימשה בתשלום כדי לראות את הסטטוס שלה.',
        'order_number' => 'מספר הזמנה',
        'email' => 'כתובת אימייל',
        'submit' => 'עקוב אחר ההזמנה',
        'not_found' => 'לא הצלחנו למצוא הזמנה התואמת למספר ההזמנה והאימייל הללו. אנא בדוק ונסה שוב.',
        'guest_dropdown_link' => 'עקוב אחר הזמנה',
    ],

    'guest_email_verification' => [
        'page_title' => 'אמת את האימייל שלך',
        'heading' => 'אמת את האימייל שלך כדי להמשיך',
        'intro' => 'כדי לעזור לנו למנוע הזמנות מזויפות, אנא אמת את כתובת האימייל שלך לפני שתמשיך לתשלום.',
        'email' => 'כתובת אימייל',
        'send_code' => 'שלח קוד אימות',
        'code_sent' => 'שלחנו קוד בן 6 ספרות אל :email. הזן אותו למטה כדי להמשיך.',
        'code' => 'קוד אימות',
        'verify' => 'אמת והמשך',
        'resend' => 'שלח קוד שוב',
        'invalid_code' => 'הקוד הזה אינו תקף או שפג תוקפו. אנא נסה שוב או שלח את הקוד שוב.',
        'email_mismatch' => 'כתובת האימייל בהזמנה שלך אינה תואמת לזו שאימתת. אנא אמת את האימייל שלך שוב כדי להמשיך.',
        'send_failed' => 'לא הצלחנו לשלוח קוד אימות לכתובת זו. אנא בדוק את הכתובת ונסה שוב.',

        'mail' => [
            'subject' => 'קוד אימות התשלום שלך',
            'title' => 'אמת את האימייל שלך',
            'intro' => 'השתמש בקוד למטה כדי לאמת את האימייל שלך ולהמשיך בהזמנה שלך. קוד זה יפוג בעוד :minutes דקות.',
            'ignore' => 'אם לא ביקשת זאת, תוכל להתעלם מאימייל זה בבטחה.',
        ],
    ],
