...
return [
    ...
    'track_order' => [
        'page_title' => 'Volg je bestelling',
        'heading' => 'Volg je bestelling',
        'intro' => 'Voer je bestelnummer en het bij het afrekenen gebruikte e-mailadres in om de status te bekijken.',
        'order_number' => 'Bestelnummer',
        'email' => 'E-mailadres',
        'submit' => 'Bestelling volgen',
        'not_found' => 'We konden geen bestelling vinden die overeenkomt met dit bestelnummer en e-mailadres. Controleer de gegevens en probeer het opnieuw.',
        'guest_dropdown_link' => 'Een bestelling volgen',
    ],

    'guest_email_verification' => [
        'page_title' => 'Bevestig je e-mailadres',
        'heading' => 'Bevestig je e-mailadres om door te gaan',
        'intro' => 'Om frauduleuze bestellingen te helpen voorkomen, bevestig je e-mailadres voordat je verdergaat naar de kassa.',
        'email' => 'E-mailadres',
        'send_code' => 'Verificatiecode versturen',
        'code_sent' => 'We hebben een 6-cijferige code gestuurd naar :email. Voer deze hieronder in om door te gaan.',
        'code' => 'Verificatiecode',
        'verify' => 'Bevestigen & Doorgaan',
        'resend' => 'Code opnieuw versturen',
        'invalid_code' => 'Die code is ongeldig of verlopen. Probeer het opnieuw of verstuur de code opnieuw.',
        'email_mismatch' => 'Het e-mailadres van je bestelling komt niet overeen met het geverifieerde adres. Bevestig je e-mailadres opnieuw om door te gaan.',
        'send_failed' => 'We konden geen verificatiecode naar dat adres sturen. Controleer het adres en probeer het opnieuw.',

        'mail' => [
            'subject' => 'Je verificatiecode voor het afrekenen',
            'title' => 'Bevestig je e-mailadres',
            'intro' => 'Gebruik de onderstaande code om je e-mailadres te bevestigen en je bestelling voort te zetten. Deze code verloopt over :minutes minuten.',
            'ignore' => 'Als je dit niet hebt aangevraagd, kun je deze e-mail gerust negeren.',
        ],
    ],
