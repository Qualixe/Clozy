...
return [
    ...
    'track_order' => [
        'page_title' => '追踪您的订单',
        'heading' => '追踪您的订单',
        'intro' => '输入您的订单号和结账时使用的电子邮箱地址以查看订单状态。',
        'order_number' => '订单号',
        'email' => '电子邮箱地址',
        'submit' => '追踪订单',
        'not_found' => '我们找不到与该订单号和电子邮箱匹配的订单。请检查后重试。',
        'guest_dropdown_link' => '追踪订单',
    ],

    'guest_email_verification' => [
        'page_title' => '验证您的电子邮箱',
        'heading' => '验证您的电子邮箱以继续',
        'intro' => '为了帮助我们防止虚假订单,请在结账前验证您的电子邮箱地址。',
        'email' => '电子邮箱地址',
        'send_code' => '发送验证码',
        'code_sent' => '我们已向 :email 发送了一个6位验证码。请在下方输入以继续。',
        'code' => '验证码',
        'verify' => '验证并继续',
        'resend' => '重新发送验证码',
        'invalid_code' => '该验证码无效或已过期。请重试或重新发送验证码。',
        'email_mismatch' => '您订单中的电子邮箱与您验证过的不匹配。请重新验证您的电子邮箱以继续。',
        'send_failed' => '我们无法向该地址发送验证码。请检查该地址后重试。',

        'mail' => [
            'subject' => '您的结账验证码',
            'title' => '验证您的电子邮箱',
            'intro' => '使用以下验证码验证您的电子邮箱并继续您的订单。此验证码将在 :minutes 分钟后过期。',
            'ignore' => '如果您没有请求此操作,可以放心忽略此邮件。',
        ],
    ],
