...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'Ver todos los resultados de',
    ...
    'track_order' => [
        'page_title' => 'Rastrea tu pedido',
        'heading' => 'Rastrea tu pedido',
        'intro' => 'Introduce tu número de pedido y el correo electrónico utilizado al finalizar la compra para ver su estado.',
        'order_number' => 'Número de pedido',
        'email' => 'Correo electrónico',
        'submit' => 'Rastrear pedido',
        'not_found' => 'No pudimos encontrar ningún pedido que coincida con ese número de pedido y correo electrónico. Comprueba los datos e inténtalo de nuevo.',
        'guest_dropdown_link' => 'Rastrear un pedido',
    ],

    'guest_email_verification' => [
        'page_title' => 'Verifica tu correo electrónico',
        'heading' => 'Verifica tu correo electrónico para continuar',
        'intro' => 'Para ayudarnos a prevenir pedidos fraudulentos, verifica tu correo electrónico antes de continuar con el pago.',
        'email' => 'Correo electrónico',
        'send_code' => 'Enviar código de verificación',
        'code_sent' => 'Enviamos un código de 6 dígitos a :email. Introdúcelo a continuación para continuar.',
        'code' => 'Código de verificación',
        'verify' => 'Verificar y continuar',
        'resend' => 'Reenviar código',
        'invalid_code' => 'Ese código no es válido o ha caducado. Inténtalo de nuevo o reenvía el código.',
        'email_mismatch' => 'El correo electrónico de tu pedido no coincide con el que verificaste. Vuelve a verificar tu correo electrónico para continuar.',
        'send_failed' => 'No pudimos enviar un código de verificación a esa dirección. Comprueba la dirección e inténtalo de nuevo.',

        'mail' => [
            'subject' => 'Tu código de verificación de pago',
            'title' => 'Verifica tu correo electrónico',
            'intro' => 'Usa el código a continuación para verificar tu correo electrónico y continuar con tu pedido. Este código caduca en :minutes minutos.',
