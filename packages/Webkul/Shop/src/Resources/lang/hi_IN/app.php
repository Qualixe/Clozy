...
return [
    ...
    'track_order' => [
        'page_title' => 'अपना ऑर्डर ट्रैक करें',
        'heading' => 'अपना ऑर्डर ट्रैक करें',
        'intro' => 'स्थिति देखने के लिए अपना ऑर्डर नंबर और चेकआउट के समय इस्तेमाल किया गया ईमेल पता दर्ज करें।',
        'order_number' => 'ऑर्डर नंबर',
        'email' => 'ईमेल पता',
        'submit' => 'ऑर्डर ट्रैक करें',
        'not_found' => 'हमें उस ऑर्डर नंबर और ईमेल से मेल खाता कोई ऑर्डर नहीं मिला। कृपया जांचें और फिर से प्रयास करें।',
        'guest_dropdown_link' => 'ऑर्डर ट्रैक करें',
    ],

    'guest_email_verification' => [
        'page_title' => 'अपना ईमेल सत्यापित करें',
        'heading' => 'जारी रखने के लिए अपना ईमेल सत्यापित करें',
        'intro' => 'फर्जी ऑर्डर रोकने में मदद के लिए, कृपया चेकआउट पर जाने से पहले अपना ईमेल पता सत्यापित करें।',
        'email' => 'ईमेल पता',
        'send_code' => 'सत्यापन कोड भेजें',
        'code_sent' => 'हमने :email पर एक 6-अंकीय कोड भेजा है। जारी रखने के लिए इसे नीचे दर्ज करें।',
        'code' => 'सत्यापन कोड',
        'verify' => 'सत्यापित करें और जारी रखें',
        'resend' => 'कोड फिर से भेजें',
        'invalid_code' => 'वह कोड अमान्य है या समाप्त हो गया है। कृपया फिर से प्रयास करें या कोड पुनः भेजें।',
        'email_mismatch' => 'आपके ऑर्डर का ईमेल आपके सत्यापित ईमेल से मेल नहीं खाता। जारी रखने के लिए कृपया अपना ईमेल फिर से सत्यापित करें।',
        'send_failed' => 'हम उस पते पर सत्यापन कोड नहीं भेज सके। कृपया पता जांचें और फिर से प्रयास करें।',

        'mail' => [
            'subject' => 'आपका चेकआउट सत्यापन कोड',
            'title' => 'अपना ईमेल सत्यापित करें',
            'intro' => 'अपना ईमेल सत्यापित करने और अपना ऑर्डर जारी रखने के लिए नीचे दिए गए कोड का उपयोग करें। यह कोड :minutes मिनट में समाप्त हो जाएगा।',
            'ignore' => 'यदि आपने यह अनुरोध नहीं किया है, तो आप इस ईमेल को सुरक्षित रूप से नज़रअंदाज़ कर सकते हैं।',
        ],
    ],
