...
return [
    ...
    'track_order' => [
        'page_title' => 'Śledź swoje zamówienie',
        'heading' => 'Śledź swoje zamówienie',
        'intro' => 'Wprowadź numer zamówienia i adres e-mail użyty podczas realizacji zakupu, aby zobaczyć jego status.',
        'order_number' => 'Numer zamówienia',
        'email' => 'Adres e-mail',
        'submit' => 'Śledź zamówienie',
        'not_found' => 'Nie znaleźliśmy zamówienia pasującego do tego numeru zamówienia i adresu e-mail. Sprawdź dane i spróbuj ponownie.',
        'guest_dropdown_link' => 'Śledź zamówienie',
    ],

    'guest_email_verification' => [
        'page_title' => 'Zweryfikuj swój e-mail',
        'heading' => 'Zweryfikuj swój e-mail, aby kontynuować',
        'intro' => 'Aby pomóc nam zapobiegać fałszywym zamówieniom, zweryfikuj swój adres e-mail przed przejściem do kasy.',
        'email' => 'Adres e-mail',
        'send_code' => 'Wyślij kod weryfikacyjny',
        'code_sent' => 'Wysłaliśmy 6-cyfrowy kod na adres :email. Wprowadź go poniżej, aby kontynuować.',
        'code' => 'Kod weryfikacyjny',
        'verify' => 'Zweryfikuj i kontynuuj',
        'resend' => 'Wyślij kod ponownie',
        'invalid_code' => 'Ten kod jest nieprawidłowy lub wygasł. Spróbuj ponownie lub wyślij kod ponownie.',
        'email_mismatch' => 'Adres e-mail w Twoim zamówieniu nie zgadza się z tym, który zweryfikowałeś. Zweryfikuj swój e-mail ponownie, aby kontynuować.',
        'send_failed' => 'Nie mogliśmy wysłać kodu weryfikacyjnego na ten adres. Sprawdź adres i spróbuj ponownie.',

        'mail' => [
            'subject' => 'Twój kod weryfikacyjny do kasy',
            'title' => 'Zweryfikuj swój e-mail',
            'intro' => 'Użyj poniższego kodu, aby zweryfikować swój e-mail i kontynuować zamówienie. Ten kod wygaśnie za :minutes minut.',
            'ignore' => 'Jeśli o to nie prosiłeś, możesz bezpiecznie zignorować tę wiadomość e-mail.',
        ],
    ],
