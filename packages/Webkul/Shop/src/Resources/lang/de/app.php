...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'Alle Ergebnisse anzeigen für',
    ...
    'track_order' => [
        'page_title' => 'Bestellung verfolgen',
        'heading' => 'Bestellung verfolgen',
        'intro' => 'Geben Sie Ihre Bestellnummer und die beim Checkout verwendete E-Mail-Adresse ein, um den Status anzuzeigen.',
        'order_number' => 'Bestellnummer',
        'email' => 'E-Mail-Adresse',
        'submit' => 'Bestellung verfolgen',
        'not_found' => 'Wir konnten keine Bestellung finden, die zu dieser Bestellnummer und E-Mail-Adresse passt. Bitte überprüfen Sie die Angaben und versuchen Sie es erneut.',
        'guest_dropdown_link' => 'Bestellung verfolgen',
    ],

    'guest_email_verification' => [
        'page_title' => 'E-Mail bestätigen',
        'heading' => 'Bestätigen Sie Ihre E-Mail, um fortzufahren',
        'intro' => 'Um betrügerische Bestellungen zu verhindern, bestätigen Sie bitte Ihre E-Mail-Adresse, bevor Sie zur Kasse gehen.',
        'email' => 'E-Mail-Adresse',
        'send_code' => 'Bestätigungscode senden',
        'code_sent' => 'Wir haben einen 6-stelligen Code an :email gesendet. Geben Sie ihn unten ein, um fortzufahren.',
        'code' => 'Bestätigungscode',
        'verify' => 'Bestätigen & Fortfahren',
        'resend' => 'Code erneut senden',
        'invalid_code' => 'Dieser Code ist ungültig oder abgelaufen. Bitte versuchen Sie es erneut oder senden Sie den Code erneut.',
        'email_mismatch' => 'Die E-Mail Ihrer Bestellung stimmt nicht mit der von Ihnen bestätigten überein. Bitte bestätigen Sie Ihre E-Mail erneut, um fortzufahren.',
        'send_failed' => 'Wir konnten keinen Bestätigungscode an diese Adresse senden. Bitte überprüfen Sie die Adresse und versuchen Sie es erneut.',

        'mail' => [
            'subject' => 'Ihr Bestätigungscode für die Kasse',
            'title' => 'E-Mail bestätigen',
            'intro' => 'Verwenden Sie den unten stehenden Code, um Ihre E-Mail zu bestätigen und mit Ihrer Bestellung fortzufahren. Dieser Code läuft in :minutes Minuten ab.',
