...
return [
    ...
    'search' => [
        ...
        'view-all-results' => 'عرض كل النتائج لـ',
    ...
    'track_order' => [
        ...
        'heading' => 'تتبع طلبك',
        'intro' => 'أدخل رقم الطلب وعنوان البريد الإلكتروني المستخدم عند الدفع لعرض حالته.',
        'order_number' => 'رقم الطلب',
        'email' => 'عنوان البريد الإلكتروني',
        'submit' => 'تتبع الطلب',
        'not_found' => 'لم نتمكن من العثور على طلب مطابق لرقم الطلب والبريد الإلكتروني هذين. يرجى التحقق والمحاولة مرة أخرى.',
        'guest_dropdown_link' => 'تتبع طلب',
    ],

    'guest_email_verification' => [
        'page_title' => 'تحقق من بريدك الإلكتروني',
        'heading' => 'تحقق من بريدك الإلكتروني للمتابعة',
        'intro' => 'للمساعدة في منع الطلبات الاحتيالية، يرجى التحقق من عنوان بريدك الإلكتروني قبل المتابعة إلى الدفع.',
        'email' => 'عنوان البريد الإلكتروني',
        'send_code' => 'إرسال رمز التحقق',
        'code_sent' => 'لقد أرسلنا رمزًا مكونًا من 6 أرقام إلى :email. أدخله أدناه للمتابعة.',
        'code' => 'رمز التحقق',
        'verify' => 'تحقق ومتابعة',
        'resend' => 'إعادة إرسال الرمز',
        'invalid_code' => 'هذا الرمز غير صالح أو انتهت صلاحيته. يرجى المحاولة مرة أخرى أو إعادة إرسال الرمز.',
        'email_mismatch' => 'البريد الإلكتروني في طلبك لا يطابق البريد الذي تحققت منه. يرجى التحقق من بريدك الإلكتروني مرة أخرى للمتابعة.',
        'send_failed' => 'لم نتمكن من إرسال رمز التحقق إلى هذا العنوان. يرجى التحقق من العنوان والمحاولة مرة أخرى.',

        'mail' => [
            'subject' => 'رمز التحقق الخاص بك عند الدفع',
            'title' => 'تحقق من بريدك الإلكتروني',
            'intro' => 'استخدم الرمز أدناه للتحقق من بريدك الإلكتروني ومتابعة طلبك. تنتهي صلاحية هذا الرمز خلال :minutes دقائق.',
