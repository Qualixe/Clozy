...
return [
    ...
    'track_order' => [
        'page_title' => 'Segueix la teva comanda',
        'heading' => 'Segueix la teva comanda',
        'intro' => 'Introdueix el número de comanda i l\'adreça de correu electrònic utilitzada en el pagament per veure el seu estat.',
        'order_number' => 'Número de comanda',
        'email' => 'Adreça de correu electrònic',
        'submit' => 'Seguir comanda',
        'not_found' => 'No hem pogut trobar cap comanda que coincideixi amb aquest número de comanda i correu electrònic. Comprova-ho i torna-ho a provar.',
        'guest_dropdown_link' => 'Seguir una comanda',
    ],

    'guest_email_verification' => [
        'page_title' => 'Verifica el teu correu electrònic',
        'heading' => 'Verifica el teu correu electrònic per continuar',
        'intro' => 'Per ajudar-nos a evitar comandes fraudulentes, verifica la teva adreça de correu electrònic abans de continuar amb el pagament.',
        'email' => 'Adreça de correu electrònic',
        'send_code' => 'Enviar codi de verificació',
        'code_sent' => 'Hem enviat un codi de 6 dígits a :email. Introdueix-lo a continuació per continuar.',
        'code' => 'Codi de verificació',
        'verify' => 'Verificar i continuar',
        'resend' => 'Reenviar codi',
        'invalid_code' => 'Aquest codi no és vàlid o ha caducat. Torna-ho a provar o reenvia el codi.',
        'email_mismatch' => 'El correu electrònic de la teva comanda no coincideix amb el que has verificat. Torna a verificar el teu correu electrònic per continuar.',
        'send_failed' => 'No hem pogut enviar un codi de verificació a aquesta adreça. Comprova l\'adreça i torna-ho a provar.',

        'mail' => [
            'subject' => 'El teu codi de verificació de pagament',
            'title' => 'Verifica el teu correu electrònic',
            'intro' => 'Utilitza el codi de sota per verificar el teu correu electrònic i continuar amb la teva comanda. Aquest codi caduca en :minutes minuts.',
            'ignore' => 'Si no has sol·licitat això, pots ignorar aquest correu electrònic amb tota seguretat.',
        ],
    ],
