...
return [
    ...
    'track_order' => [
        'page_title' => 'Siparişinizi Takip Edin',
        'heading' => 'Siparişinizi Takip Edin',
        'intro' => 'Durumunu görmek için sipariş numaranızı ve ödeme sırasında kullandığınız e-posta adresini girin.',
        'order_number' => 'Sipariş numarası',
        'email' => 'E-posta adresi',
        'submit' => 'Siparişi Takip Et',
        'not_found' => 'Bu sipariş numarası ve e-postayla eşleşen bir sipariş bulamadık. Lütfen kontrol edip tekrar deneyin.',
        'guest_dropdown_link' => 'Bir Siparişi Takip Et',
    ],

    'guest_email_verification' => [
        'page_title' => 'E-postanızı Doğrulayın',
        'heading' => 'Devam etmek için e-postanızı doğrulayın',
        'intro' => 'Sahte siparişleri önlememize yardımcı olmak için lütfen ödeme adımına geçmeden önce e-posta adresinizi doğrulayın.',
        'email' => 'E-posta adresi',
        'send_code' => 'Doğrulama Kodu Gönder',
        'code_sent' => ':email adresine 6 haneli bir kod gönderdik. Devam etmek için aşağıya girin.',
        'code' => 'Doğrulama kodu',
        'verify' => 'Doğrula ve Devam Et',
        'resend' => 'Kodu tekrar gönder',
        'invalid_code' => 'Bu kod geçersiz veya süresi dolmuş. Lütfen tekrar deneyin veya kodu yeniden gönderin.',
        'email_mismatch' => 'Siparişinizdeki e-posta, doğruladığınız e-posta ile eşleşmiyor. Devam etmek için lütfen e-postanızı tekrar doğrulayın.',
        'send_failed' => 'Bu adrese doğrulama kodu gönderemedik. Lütfen adresi kontrol edip tekrar deneyin.',

        'mail' => [
            'subject' => 'Ödeme doğrulama kodunuz',
            'title' => 'E-postanızı Doğrulayın',
            'intro' => 'E-postanızı doğrulamak ve siparişinize devam etmek için aşağıdaki kodu kullanın. Bu kodun süresi :minutes dakika içinde dolacak.',
            'ignore' => 'Bunu siz talep etmediyseniz, bu e-postayı güvenle yok sayabilirsiniz.',
        ],
    ],
