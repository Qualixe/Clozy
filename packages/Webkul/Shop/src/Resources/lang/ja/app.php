...
return [
    ...
    'track_order' => [
        'page_title' => '注文を追跡する',
        'heading' => '注文を追跡する',
        'intro' => '注文状況を確認するには、注文番号とご注文時に使用したメールアドレスを入力してください。',
        'order_number' => '注文番号',
        'email' => 'メールアドレス',
        'submit' => '注文を追跡',
        'not_found' => 'その注文番号とメールアドレスに一致する注文が見つかりませんでした。内容をご確認の上、もう一度お試しください。',
        'guest_dropdown_link' => '注文を追跡する',
    ],

    'guest_email_verification' => [
        'page_title' => 'メールアドレスを確認する',
        'heading' => '続行するにはメールアドレスを確認してください',
        'intro' => '不正な注文を防ぐため、チェックアウトに進む前にメールアドレスを確認してください。',
        'email' => 'メールアドレス',
        'send_code' => '確認コードを送信',
        'code_sent' => ':email に6桁のコードを送信しました。続行するには以下に入力してください。',
        'code' => '確認コード',
        'verify' => '確認して続行',
        'resend' => 'コードを再送信',
        'invalid_code' => 'そのコードは無効か期限切れです。もう一度お試しいただくか、コードを再送信してください。',
        'email_mismatch' => 'ご注文のメールアドレスが確認済みのものと一致しません。続行するにはメールアドレスを再度確認してください。',
        'send_failed' => 'そのアドレスに確認コードを送信できませんでした。アドレスを確認して、もう一度お試しください。',

        'mail' => [
            'subject' => 'チェックアウト確認コード',
            'title' => 'メールアドレスを確認する',
            'intro' => '以下のコードを使用してメールアドレスを確認し、注文を続行してください。このコードは:minutes分で期限切れになります。',
            'ignore' => 'これをリクエストしていない場合は、このメールを無視して問題ありません。',
        ],
    ],
