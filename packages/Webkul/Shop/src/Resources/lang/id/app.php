...
return [
    ...
    'track_order' => [
        'page_title' => 'Lacak Pesanan Anda',
        'heading' => 'Lacak Pesanan Anda',
        'intro' => 'Masukkan nomor pesanan dan alamat email yang digunakan saat checkout untuk melihat statusnya.',
        'order_number' => 'Nomor pesanan',
        'email' => 'Alamat email',
        'submit' => 'Lacak Pesanan',
        'not_found' => 'Kami tidak dapat menemukan pesanan yang cocok dengan nomor pesanan dan email tersebut. Silakan periksa dan coba lagi.',
        'guest_dropdown_link' => 'Lacak Pesanan',
    ],

    'guest_email_verification' => [
        'page_title' => 'Verifikasi Email Anda',
        'heading' => 'Verifikasi Email Anda untuk Melanjutkan',
        'intro' => 'Untuk membantu mencegah pesanan palsu, silakan verifikasi alamat email Anda sebelum melanjutkan ke checkout.',
        'email' => 'Alamat email',
        'send_code' => 'Kirim Kode Verifikasi',
        'code_sent' => 'Kami mengirim kode 6 digit ke :email. Masukkan di bawah ini untuk melanjutkan.',
        'code' => 'Kode verifikasi',
        'verify' => 'Verifikasi & Lanjutkan',
        'resend' => 'Kirim ulang kode',
        'invalid_code' => 'Kode tersebut tidak valid atau telah kedaluwarsa. Silakan coba lagi atau kirim ulang kode.',
        'email_mismatch' => 'Email pada pesanan Anda tidak cocok dengan yang telah Anda verifikasi. Silakan verifikasi ulang email Anda untuk melanjutkan.',
        'send_failed' => 'Kami tidak dapat mengirim kode verifikasi ke alamat tersebut. Silakan periksa alamatnya dan coba lagi.',

        'mail' => [
            'subject' => 'Kode verifikasi checkout Anda',
            'title' => 'Verifikasi Email Anda',
            'intro' => 'Gunakan kode di bawah ini untuk memverifikasi email Anda dan melanjutkan pesanan Anda. Kode ini kedaluwarsa dalam :minutes menit.',
            'ignore' => 'Jika Anda tidak meminta ini, Anda dapat mengabaikan email ini dengan aman.',
        ],
    ],
