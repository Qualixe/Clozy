...
class OnepageController extends APIController
{
    ...
    public function storeOrder()
    {
        ...
        session()->forget('checkout_verified_email');
    ...
    public function validateOrder()
    {
        ...
        /**
         * Guest email OTP verification guard — disabled for now, matching
         * the entry-gate in the web OnepageController. Uncomment together
         * with that gate to re-enable once mail is working.
         */
        // if (! auth()->guard('customer')->check()) {
        //     $verifiedEmail = session('checkout_verified_email');
        //     $billingEmail = $cart->billing_address->email;
        //
        //     if (
        //         ! $verifiedEmail
        //         || mb_strtolower($verifiedEmail) !== mb_strtolower($billingEmail)
        //     ) {
        //         session()->forget('checkout_verified_email');
        //
        //         throw new \Exception(trans('shop::app.guest_email_verification.email_mismatch'));
        //     }
        // }
