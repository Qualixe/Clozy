...
class OnepageController extends Controller
{
    ...
    public function index()
    {
        ...
        /**
         * Guest email OTP verification gate — disabled for now (SMTP isn't
         * fully configured yet, so guests were getting blocked). The
         * verify-email route, controller, and mailer are all still in
         * place; uncomment this block to re-enable once mail is working.
         */
        // if (
        //     ! auth()->guard('customer')->check()
        //     && ! session('checkout_verified_email')
        // ) {
        //     return redirect()->route('shop.checkout.verify_email.index');
        // }
